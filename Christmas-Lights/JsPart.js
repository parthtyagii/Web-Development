...
// if (document.querySelector("#interval").value >= 1000 && document.querySelector("#interval").value <= 10000) {
//     delay = document.querySelector("#interval").value;
// }
// circle1.style.opacity = 1;
//         circle1.style.boxShadow = "30px 0 30px violet, -30px 0 30px violet, 0 30px 30px violet, 0 -30px 30px violet";
...
//             circle2.style.opacity = 1;
//             circle2.style.boxShadow = "30px 0 30px indigo, -30px 0 30px indigo, 0 30px 30px indigo, 0 -30px 30px indigo";
...
//                 circle3.style.opacity = 1;
//                 circle3.style.boxShadow = "30px 0 30px blue, -30px 0 30px blue, 0 30px 30px blue, 0 -30px 30px blue";
...
//                     circle4.style.opacity = 1;
//                     circle4.style.boxShadow = "30px 0 30px green, -30px 0 30px green, 0 30px 30px green, 0 -30px 30px green";
...
//                         circle5.style.opacity = 1;
//                         circle5.style.boxShadow = "30px 0 30px yellow, -30px 0 30px yellow, 0 30px 30px yellow, 0 -30px 30px yellow";
...
//                             circle6.style.opacity = 1;
//                             circle6.style.boxShadow = "30px 0 30px orange, -30px 0 30px orange, 0 30px 30px orange, 0 -30px 30px orange";
...
//                                 circle7.style.opacity = 1;
//                                 circle7.style.boxShadow = "30px 0 30px red, -30px 0 30px red, 0 30px 30px red, 0 -30px 30px red";
